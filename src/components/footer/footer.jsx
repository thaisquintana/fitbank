  ...
  <footer className="footer">
    <div className="footer-content">
      <div className="footer-content-links">
        ...
        <nav className="footer-content-links__primary">
          <ul>
            <li>
        ...
        <nav className="footer-content-links__secondary">
          <ul>
            <li>
      ...
      <div className="footer-content-promo-links">
        <nav className="footer-content-promotion">
          <a href="https://www.marvel.com/insider?start_location=footer">
            <div className="footer-content-promotion__image">
              <img
                src="https://terrigen-cdn-dev.marvel.com/content/prod/1x/marvel_insider-topnav-logo-large2x.png"
                alt="Marvel Insider Logo"
              />
            </div>
            <div className="footer-content-promotion__detail">
              <h4>Marvel insider</h4>
              <p>Get Rewarded for Beign a Marvel Fan</p>
            </div>
          </a>
        </nav>
        <nav className="footer-content-promotion">
          <a href="https://www.marvel.com/creditcard?siteCode=MCMOFL&amp;Dcom=MCMOFL&amp;cid=MMCMDC&amp;clientCode=MARVEL">
            <div className="footer-content-promotion__image">
              <img
                src="https://terrigen-cdn-dev.marvel.com/content/prod/1x/mastercard-crop_0-footer-v3.png"
                alt="Marvel Mastercard"
              />
            </div>
            <div className="footer-content-promotion__detail">
              <h4>Marvel Mastercard®</h4>
              <p>6 cards Designs - Unlimeted Cashback</p>
            </div>
          </a>
        </nav>
      </div>
      <div className="footer-content-social">
        <h4 className="footer-content-social__title">Follow Marvel</h4>
        <ul className="footer-content-social__links">
          <li className="footer-content-social__img">
            <a
          ...
          <li className="footer-content-social__img">
            <a
              ...
              aria-label="follow us on Pinteres"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="18"
